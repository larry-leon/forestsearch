...
- the **Controlled Direct Effect (CDE)** — a ratio of average hazards on
  the natural scale (Aalen, Cook & Røysland, 2015),
...
treatment versus control (Aalen, Cook & Røysland, 2015):
...
Both Aalen, Cook & Røysland (2015) and Fay & Li (2024) identify the AFT
...
"collider" argument of Hernán 2010; Aalen et al. 2015; Martinussen
...
The mathematical pipeline above — AFT model → hazard-scale
transformation (4) → individual log-HR → AHR/CDE aggregation — is
...
- Aalen, O.O., Cook, R.J. & Røysland, K. (2015). Does Cox analysis of
