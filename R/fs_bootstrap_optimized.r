...
# Keep original helper functions exactly as they are
...
# All other helper functions remain unchanged to maintain compatibility
# Including: bootstrap_ystar, ensure_packages, build_cox_formula, 
# fit_cox_models, format_CI, etc.