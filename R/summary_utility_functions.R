...
#' @importFrom weightedSurv dfcount
#' @export
...
sg_tables <- function(fs, which_df = "est", est_caption = "Training data estimates", potentialOutcome.name = NULL, hr_1a = NA, hr_0a = NA, ndecimals = 3){
