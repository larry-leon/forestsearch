# ============================================================================
# FORESTSEARCH COMPREHENSIVE TEST SUITE - FILE GENERATOR
# ============================================================================
# This script creates a complete R Markdown file for testing ForestSearch
#
# Usage:
#   1. Run this entire script in R
#   2. It will create "forestsearch_comprehensive_test.Rmd" in your working directory
#   3. Open the .Rmd file in RStudio and click "Knit" to generate the HTML report
# ============================================================================

create_forestsearch_test_rmd <- function(
    output_dir = getwd(),
    filename = "forestsearch_comprehensive_test.Rmd"
) {
  ...
  if (file.exists(filepath)) {
    cat("⚠ File already exists:", filepath, "\n")
    response <- readline(prompt = "Overwrite? (yes/no): ")
  ...
  cat("Creating ForestSearch Test R Markdown file...\n")
  cat("Location:", filepath, "\n\n")

  # Open file connection
  con <- file(filepath, "w", encoding = "UTF-8")

  # Write the complete R Markdown content
  writeLines(c(
    '---',
  ...
  cat("  Location:", normalizePath(filepath), "\n\n")
  cat("Next steps:\n")
  cat("  1. Open in RStudio:", basename(filepath), "\n")
  cat("  2. Click 'Knit' button or press Ctrl+Shift+K (Cmd+Shift+K on Mac)\n")
  cat("  3. Or run: rmarkdown::render('", basename(filepath), "')\n", sep = "")
...
cat("============================================================================\n")
cat("FORESTSEARCH COMPREHENSIVE TEST SUITE - FILE GENERATOR\n")
cat("============================================================================\n\n")

# Create the file
file_created <- create_forestsearch_test_rmd()

if (!is.null(file_created)) {
  cat("\n")
  cat("============================================================================\n")
  cat("SUCCESS! File created and ready to use.\n")
  cat("============================================================================\n")

  # Optional: Open the file in RStudio
  if (interactive() && require("rstudioapi", quietly = TRUE)) {
    open_response <- readline(prompt = "Open file in RStudio now? (yes/no): ")
    if (tolower(open_response) == "yes") {
      rstudioapi::navigateToFile(file_created)
      cat("\n✓ File opened in RStudio\n")
    }
  }
}

cat("\n")
cat("To render the document:\n")
cat("  > rmarkdown::render('forestsearch_comprehensive_test.Rmd')\n\n")
