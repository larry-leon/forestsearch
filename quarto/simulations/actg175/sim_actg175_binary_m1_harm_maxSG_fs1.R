...
#   actg175_binary_m1_harm_maxSG_fs1.R    — background runner script
#   actg175_binary_m1_harm_maxSG_fs1.rds  — saved bundle (output)
#
# This file defines a single function, run_sim_actg175_binary_m1_harm_maxSG_fs1(),
...
#' Run ACTG175 binary harm maxSG fs1 simulations
#'
#' Pure simulation core for configuration
#' \code{actg175_binary_m1_harm_maxSG_fs1}. Runs the H1 (calibrated HTE) and
...
#'   Defaults to \code{"actg175_binary_m1_harm_maxSG_fs1"}.
#'
...
#'
#' @seealso
#'   The companion vignette \code{actg175_binary_m1_harm_maxSG_fs1.qmd}
#'   demonstrates the same loops inline, with mode logic for
#'   \code{import} / \code{demo} / \code{full} runs.
run_sim_actg175_binary_m1_harm_maxSG_fs1 <- function(
    dgm_calibrated,
    dgm_null,
    n_alt,
    n_null,
