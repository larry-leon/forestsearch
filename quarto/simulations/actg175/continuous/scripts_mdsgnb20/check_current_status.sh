#!/bin/bash
# Post-condition for the actg175/continuous closeout step:
#   the pin stated in current_status.md == HEAD at the time it was committed.
# Transplant of quarto/simulations/gbsg_020/scripts_dinamr/check_current_status.sh
# (TASK_md_field_rerun_2026-09-15 §3.4): bash for zsh; F points at this directory.
...
F=quarto/simulations/actg175/continuous/current_status.md
