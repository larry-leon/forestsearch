...
- Stem: `grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf`; HEAD before this cell's commit: f84261e3; workers 63; threads 1.
- Knobs: `FS_MD_METHOD=grf FS_MD_DMIN_GRF=30 FS_MD_FOCUS=effMaxSG FS_MD_NBHD=0.20 FS_MD_FIELD_SCALEC=selected FS_MD_CI=field FS_MD_CAMPAIGN=mdgrf FS_MD_FB=none FS_MD_MD=null FS_MD_N=500 FS_MD_WORKERS=63`.
- Seeds: 8316951 + sim_id; batches sim_id 1-1000 and 1001-2000, then combine.
- Cell wall: 1718 s; cumulative render wall 5400 s (ceiling 11870 s).
- Render: WALL_SECONDS=836 RC=0 PEAK_MB=58198 OUT=grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_batch_1001_2000.html
- Render: WALL_SECONDS=842 RC=0 PEAK_MB=57536 OUT=grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_batch_1_1000.html
- Render: WALL_SECONDS=40 RC=0 PEAK_MB=1109 OUT=grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_combine_1_2000.html
- Gate counts: `GATE_COUNTS run=66 passed=66 failed=0`.

```

########## GATE 2 (mdgrf): null_n500 -- md null, n 500 ##########
  Every coverage figure of this campaign is conditional on the proposed family.
  bundle: ../mr_md_harm/grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_d5000/grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_combined_1_2000.rds
  combined payload on disk                                       PASS     
  --- combine assertions ---
  exactly 2 batch files, res_1_1000 and res_1001_2000            PASS     (2)
  2,000 rows                                                     PASS     (2000)
  ...
  meta: hostname == pop-os                                       PASS     (pop-os / pop-os)
  meta: n_workers == 63                                          PASS     (63 / 63)
  meta seed_base 8316951 | host pop-os | R 4.6.1 | built_at 2026-09-16 23:36:45 / 2026-09-16 23:22:50
  >> DECLARATION RATE         : 1.0000 (2000 / 2000)
  MR failures on declared replicates <= 40                       PASS     (0)
  >> ADMITTED_N (qualified)   : min 7  q25 265.75  MED 479  q75 731.25  p90 925.3  max 1245  (mean 508.5, n 2000); == 0 on 0 row(s)
  >> N_FAMILY (ENUMERATED POOL, not the qualified set): min 1170  med 1199  p90 1283  max 1526
  admitted_n recorded on every row                               PASS     (2000 of 2000)
  admitted_n >= 1 on every declared replicate                    PASS     
  n_family finite on every declared replicate with a gate        PASS     
  ...
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (2000 of 2000 agree; max |diff| 0)
  identity: lo1s = beta-tilde - q95; up1s = beta-tilde^c - q05   PASS     max |diff| = 0
  >> p-hat(H): mean 0.103, share < 0.5: 0.998 | CLASSIFICATION: sens NaN ppv 0.0000 | mean |Hhat| (n_harm) 106.1
  mdsgnb20 comparator on disk                                    PASS     fs_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdsgnb20_combined_1_2000.rds
  --- same-draws: mdgrf -> mdsgnb20 ---
  [mdgrf -> mdsgnb20] same sim_id set (2000 rows)                PASS     (comparator 2000 rows)
  [mdgrf -> mdsgnb20] n_true identical() on all rows             PASS     
  [mdgrf -> mdsgnb20] oracle columns (complement only) <= 1e-08 relative on all rows PASS     (max 0)
  --- same-draws: mdsgnb20 -> mdgrf ---
  [mdsgnb20 -> mdgrf] same sim_id set (2000 rows)                PASS     (comparator 2000 rows)
  [mdsgnb20 -> mdgrf] n_true identical() on all rows             PASS     
  [mdsgnb20 -> mdgrf] oracle columns (complement only) <= 1e-08 relative on all rows PASS     (max 0)
  FS comparator (same cell): declaration 0.9965 | mean |Hhat| 107.5
  size <= 100 MB: grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_res_1_1000.rds PASS     (705481 B)
  size <= 100 MB: grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_res_1001_2000.rds PASS     (706267 B)
  size <= 100 MB: grf_effMaxSG_mr_field_mdnull_knoise0_n500_nb20_mdgrf_combined_1_2000.rds PASS     (1390446 B)
  timing: fit_mr_secs mean 44.1 median 44.9 p90 48.5 max 53.1 | id_secs (GRF fit) mean 5.96 median 6.08 max 8.58 | fld_H_secs mean 26.3 | fld_Hc_secs mean 1.71
...
- Stem: `grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf`; HEAD before this cell's commit: 15bee7cd; workers 63; threads 1.
- Knobs: `FS_MD_METHOD=grf FS_MD_DMIN_GRF=30 FS_MD_FOCUS=effMaxSG FS_MD_NBHD=0.20 FS_MD_FIELD_SCALEC=selected FS_MD_CI=field FS_MD_CAMPAIGN=mdgrf FS_MD_FB=none FS_MD_MD=40 FS_MD_N=700 FS_MD_WORKERS=63`.
- Seeds: 8316951 + sim_id; batches sim_id 1-1000 and 1001-2000, then combine.
- Cell wall: 2023 s; cumulative render wall 7423 s (ceiling 11870 s).
- Render: WALL_SECONDS=989 RC=0 PEAK_MB=64611 OUT=grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_batch_1001_2000.html
- Render: WALL_SECONDS=994 RC=0 PEAK_MB=65133 OUT=grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_batch_1_1000.html
- Render: WALL_SECONDS=40 RC=0 PEAK_MB=1184 OUT=grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_combine_1_2000.html
- Gate counts: `GATE_COUNTS run=66 passed=66 failed=0`.

```

########## GATE 2 (mdgrf): md40_n700 -- md 40, n 700 ##########
  Every coverage figure of this campaign is conditional on the proposed family.
  bundle: ../mr_md_harm/grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_d5000/grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_combined_1_2000.rds
  combined payload on disk                                       PASS     
  --- combine assertions ---
  exactly 2 batch files, res_1_1000 and res_1001_2000            PASS     (2)
  2,000 rows                                                     PASS     (2000)
  ...
  meta: hostname == pop-os                                       PASS     (pop-os / pop-os)
  meta: n_workers == 63                                          PASS     (63 / 63)
  meta seed_base 8316951 | host pop-os | R 4.6.1 | built_at 2026-09-17 00:10:32 / 2026-09-16 23:54:00
  >> DECLARATION RATE         : 1.0000 (2000 / 2000)
  MR failures on declared replicates <= 40                       PASS     (0)
  >> ADMITTED_N (qualified)   : min 17  q25 470.75  MED 718  q75 973.25  p90 1123.1  max 1360  (mean 711.4, n 2000); == 0 on 0 row(s)
  >> N_FAMILY (ENUMERATED POOL, not the qualified set): min 1309  med 1337  p90 1424  max 1549
  admitted_n recorded on every row                               PASS     (2000 of 2000)
  admitted_n >= 1 on every declared replicate                    PASS     
  n_family finite on every declared replicate with a gate        PASS     
  p_hat_H and p_hat_sum recorded on declared replicates with a gate PASS     
  ...
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (2000 of 2000 agree; max |diff| 0)
  identity: lo1s = beta-tilde - q95; up1s = beta-tilde^c - q05   PASS     max |diff| = 0
  >> p-hat(H): mean 0.099, share < 0.5: 1.000 | CLASSIFICATION: sens 0.1873 ppv 0.3863 | mean |Hhat| (n_harm) 116.3
  mdsgnb20 comparator on disk                                    PASS     fs_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdsgnb20_combined_1_2000.rds
  --- same-draws: mdgrf -> mdsgnb20 ---
  [mdgrf -> mdsgnb20] same sim_id set (2000 rows)                PASS     (comparator 2000 rows)
  [mdgrf -> mdsgnb20] n_true identical() on all rows             PASS     
  [mdgrf -> mdsgnb20] oracle columns (H and Hc) <= 1e-08 relative on all rows PASS     (max 0)
  ...
  [mdsgnb20 -> mdgrf] n_true identical() on all rows             PASS     
  [mdsgnb20 -> mdgrf] oracle columns (H and Hc) <= 1e-08 relative on all rows PASS     (max 0)
  FS comparator (same cell): declaration 0.9995 | mean |Hhat| 118.0
  size <= 100 MB: grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_res_1_1000.rds PASS     (764837 B)
  size <= 100 MB: grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_res_1001_2000.rds PASS     (765089 B)
  size <= 100 MB: grf_effMaxSG_mr_field_md40_knoise0_n700_nb20_mdgrf_combined_1_2000.rds PASS     (1505636 B)
  timing: fit_mr_secs mean 53.5 median 54.5 p90 58.1 max 64.8 | id_secs (GRF fit) mean 7.18 median 7.34 max 10.05 | fld_H_secs mean 29.3 | fld_Hc_secs mean 2.39
