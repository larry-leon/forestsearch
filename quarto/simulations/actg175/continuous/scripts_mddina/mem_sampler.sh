...
# Transplant of scripts_mdgrf/mem_sampler.sh (TASK_md_dina_campaign_2026-09-17 §1.6), unchanged; itself scripts_mdsgnb20/mem_sampler.sh; that one was scripts_mdf1's with
