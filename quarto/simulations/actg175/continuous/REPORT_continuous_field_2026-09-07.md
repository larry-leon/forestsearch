...
Complement block, one-sided 95% UPPER bound: share at or below each threshold ("harm at most τ" supported). The complement's oriented β(Ĥᶜ) is about +31 in the md40 cells, +26 under the null and +52 in md120 (the treatment lowers CD4 change everywhere on this DGM, and in md120 two thirds of Q sit in Ĥᶜ), so a benefit claim on Ĥᶜ is not supported at any threshold, and the shares below 30 are correctly small.
