...
## orgrf_or150_n2000 — identifier grf, target_or_h 1.5, n 2000

- Stem: `grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf`; HEAD before this cell's commit: f2c5791c; workers 13; threads 1.
- Knobs: `FS_OR_METHOD=grf FS_OR_FOCUS=effMaxSG FS_OR_NBHD=0.20 FS_OR_RULE=neighborhood FS_OR_CI=field FS_OR_FIELD_SCALEC=selected FS_OR_CAMPAIGN=orgrf FS_OR_TARGET=1.5 FS_OR_N=2000 FS_OR_WORKERS=13`.
- Seeds: the study's pre-generated table indexed by global sim_id (seed_base 8316951); one batch, sim_id 1-1000, then combine.
- Replicates: 1000 (TASK_binary_launch_v2_2026-09-18; the superseded 2 x 1,000 layout is not used).
- Package: R 4.5.2; ; 2026-09-19 20:23:40 UTC; unix.
- Cell wall: 2070 s; cumulative render wall 2069 s (ceiling 440000 s).
- Render: WALL_SECONDS=2054 RC=0 PEAK_MB=17568 OUT=grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_batch_1_1000.html
- Render: WALL_SECONDS=15 RC=0 PEAK_MB=1732 OUT=grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_combine_1_1000.html
- Gate counts: `GATE_COUNTS run=87 passed=87 failed=0`.

```

########## GATE 2 (orgrf): orgrf_or150_n2000 -- target_or_h 1.5, n 2000, identifier grf ##########
  Every coverage figure of this campaign is coverage of beta(H-hat) CONDITIONAL ON THE PROPOSED FAMILY.
  bundle: ../mr_or_harm/grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_d5000/grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_combined_1_1000.rds
  combined payload on disk                                               PASS     
  --- combine assertions ---
  exactly 1 batch file, res_1_1000                                       PASS     (1)
  1,000 rows                                                             PASS     (1000)
  ...
  meta: n_workers == 13                                                  PASS     (13)
  meta carries the truths                                                PASS     (marg_H 1.5000000002 | marg_Hc 0.6564077470 | cde_H 1.5414142152 | cde_Hc 0.6313905111 | prev 0.149170)
  meta seed_base 8316951 | seed_scheme pre-generated table indexed by global sim_id | host Mac-Studio-3.local | R 4.5.2 | pkg_commit f2c5791c | built_at 2026-09-19 15:54:01
  --- launch record (combined meta) ---
  meta: n_sims == 1000                                                   PASS     (1000)
  meta: Stage 0 feasibility gate green, not overridden                   PASS     (feasible TRUE, override FALSE, tol 0.05, shares n500=0.015|n750=0.000|n1000=0.000|n2000=0.000)
  meta: the oracle helper assertion passed in the render                 PASS     (TRUE)
  meta: wall clock recorded                                              PASS     (1970 s total; by batch 1970)
  meta: the non-estimable / NA-oracle counts recorded                    PASS     (n_na_oracle_H=0, n_na_oracle_Hc=0, n_nonestimable_H=0, n_nonestimable_Hc=0)
  >> NA-ORACLE (true region)  : H 0 / 1000, Hc 0 / 1000
  >> NON-ESTIMABLE (selected) : H 0, Hc 0 (of the declared replicates)
  >> PREVALENCE(H) / sg_quantile: 0.149170 / 0.62850 | pkg 0.3.5.9000 built 2026-09-19 15:54:01 | workers 13
  >> DECLARATION RATE         : 1.0000 (1000 / 1000)
  MR failures on declared replicates <= 40                               PASS     (0)
  >> N_FAMILY (MR's kept family K): min 1339  med 1351  p90 1447  max 1552
  >> ADMITTED_N               : min 11  q25 140.75  MED 212  q75 322.25  p90 447.1  max 899  (mean 248.7, n 1000); == 0 on 0 row(s)
  STRUCTURAL n_cons_qual  present, all-NA -- STRUCTURAL (no consistency screen) on grf, NOT a failure
  STRUCTURAL band_n       present, all-NA -- STRUCTURAL (no consistency screen) on grf, NOT a failure
  n_family finite on every declared replicate with a gate                PASS     
  p_hat_H and p_hat_sum recorded on declared replicates with a gate      PASS     
  ...
  identity: log(lo1s) = log(beta-tilde) - q95; log(up1s) = log(beta-tilde^c) - q05 PASS     max |diff| = 2.22e-16
  C_dagger_* / C_ddagger_* equal the truth table on every row            PASS     
  >> p-hat(H): mean 0.190, share < 0.5: 0.966 | CLASSIFICATION: sens 0.2855 ppv 0.4960 | mean |Hhat| 154.3
  >> BOUNDS: mean fld_H_lo1s 0.4873 | share >= 1.0 0.029 | mean fld_Hc_up1s_s 0.8490 | share <= 1.0 0.956
  orfs comparator on disk                                                PASS     fs_effMaxSG_mr_field_or150_n2000_nb20_orfs_combined_1_1000.rds
  --- same draws as orfs: orgrf -> orfs ---
  [orgrf -> orfs] same sim_id set (1000 rows)                            PASS     (comparator 1000 rows)
  [orgrf -> orfs] the data-level columns (10: seed, n_true, the 8 oracle columns) <= 1e-08 relative PASS     (max 4.5e-14)
  [orgrf -> orfs] seed identical() on all rows                           PASS     
  ...
  [orfs -> orgrf] seed identical() on all rows                           PASS     
  [orfs -> orgrf] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  orfs comparator (same cell): declaration 0.9980 | mean |Hhat| 137.5 | mean fld_H_lo1s 0.4917
  size <= 100 MB: grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_res_1_1000.rds PASS     (757539 B)
  size <= 100 MB: grf_effMaxSG_mr_field_or150_n2000_nb20_orgrf_combined_1_1000.rds PASS     (757597 B)
  timing: fit_mr_secs mean 25.1 median 25.0 p90 27.7 max 30.4 | id_secs mean 4.26 median 4.22 max 5.96 | fld_H_secs mean 15.9 | fld_Hc_secs mean 0.92

GATE_COUNTS run=87 passed=87 failed=0
```

## ordina_or075_n500 — identifier dina, target_or_h 0.75, n 500

- Stem: `dina_effMaxSG_mr_field_or075_n500_nb20_ordina`; HEAD before this cell's commit: cfe33cc5; workers 13; threads 1.
- Knobs: `FS_OR_METHOD=dina FS_OR_FOCUS=effMaxSG FS_OR_NBHD=0.20 FS_OR_RULE=neighborhood FS_OR_CI=field FS_OR_FIELD_SCALEC=selected FS_OR_CAMPAIGN=ordina FS_OR_TARGET=0.75 FS_OR_N=500 FS_OR_WORKERS=13`.
- Seeds: the study's pre-generated table indexed by global sim_id (seed_base 8316951); one batch, sim_id 1-1000, then combine.
- Replicates: 1000 (TASK_binary_launch_v2_2026-09-18; the superseded 2 x 1,000 layout is not used).
- Package: R 4.5.2; ; 2026-09-19 20:23:40 UTC; unix.
- Cell wall: 1330 s; cumulative render wall 1329 s (ceiling 440000 s).
- Render: WALL_SECONDS=1314 RC=0 PEAK_MB=17656 OUT=dina_effMaxSG_mr_field_or075_n500_nb20_ordina_batch_1_1000.html
- Render: WALL_SECONDS=15 RC=0 PEAK_MB=1579 OUT=dina_effMaxSG_mr_field_or075_n500_nb20_ordina_combine_1_1000.html
- Gate counts: `GATE_COUNTS run=88 passed=88 failed=0`.

```

########## GATE 2 (ordina): ordina_or075_n500 -- target_or_h 0.75, n 500, identifier dina ##########
  Every coverage figure of this campaign is coverage of beta(H-hat) CONDITIONAL ON THE PROPOSED FAMILY.
  bundle: ../mr_or_harm/dina_effMaxSG_mr_field_or075_n500_nb20_ordina_d5000/dina_effMaxSG_mr_field_or075_n500_nb20_ordina_combined_1_1000.rds
  combined payload on disk                                               PASS     
  --- combine assertions ---
  exactly 1 batch file, res_1_1000                                       PASS     (1)
  1,000 rows                                                             PASS     (1000)
  ...
  meta: n_workers == 13                                                  PASS     (13)
  meta carries the truths                                                PASS     (marg_H 0.7499999940 | marg_Hc 0.6564077470 | cde_H 0.7345268290 | cde_Hc 0.6313905111 | prev 0.149170)
  meta seed_base 8316951 | seed_scheme pre-generated table indexed by global sim_id | host Mac-Studio-3.local | R 4.5.2 | pkg_commit cfe33cc5 | built_at 2026-09-19 16:16:16
  --- launch record (combined meta) ---
  meta: n_sims == 1000                                                   PASS     (1000)
  meta: Stage 0 feasibility gate green, not overridden                   PASS     (feasible TRUE, override FALSE, tol 0.05, shares n500=0.015|n750=0.000|n1000=0.000|n2000=0.000)
  meta: the oracle helper assertion passed in the render                 PASS     (TRUE)
  meta: wall clock recorded                                              PASS     (1229 s total; by batch 1229)
  meta: the non-estimable / NA-oracle counts recorded                    PASS     (n_na_oracle_H=0, n_na_oracle_Hc=0, n_nonestimable_H=0, n_nonestimable_Hc=0)
  >> NA-ORACLE (true region)  : H 0 / 1000, Hc 0 / 1000
  >> NON-ESTIMABLE (selected) : H 0, Hc 0 (of the declared replicates)
  >> PREVALENCE(H) / sg_quantile: 0.149170 / 0.62850 | pkg 0.3.5.9000 built 2026-09-19 16:16:16 | workers 13
  >> DECLARATION RATE         : 0.9440 (944 / 1000)
  MR failures on declared replicates <= 40                               PASS     (0)
  >> N_FAMILY (MR's kept family K): min 1  med 427  p90 2292.8  max 6112
  >> ADMITTED_N               : min 1  q25 65  MED 231.5  q75 615  p90 1244.9  max 5019  (mean 494.7, n 944); == 0 on 0 row(s)
  >> DINA_PROPOSED_N          : min 1  q25 140.5  MED 427  q75 1115.25  p90 2292.8  max 6112  (mean 851.9, n 944); searched 7780-8498
  DINA proposal fields filled on every declared replicate                PASS     (dina_searched_n 944/944, dina_proposed_n 944/944, dina_tau_min 944/944, admitted_n 944/944)
  every proposed candidate at oriented tau-hat >= log(0.90), the OR effect threshold on the harm side PASS     (min -0.10536038 = OR 0.900000; floor log(0.90) = -0.10536052)
  1 <= admitted_n <= dina_proposed_n on every declared replicate         PASS     
  STRUCTURAL n_cons_qual  present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  STRUCTURAL band_n       present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  n_family finite on every declared replicate with a gate                PASS     
  ...
  zero factor-comparison warnings                                        PASS     
  every finiteness column present (incl. C_dagger_* / C_ddagger_*)       PASS     
  harm products finite on declared replicates with a field block         PASS     (944 rows)
  nine fld_Hc_*_s and nine fld_joint_s_* columns present                 PASS     
  fld_Hc_*_s finite on all 944 filled replicates                         PASS     
  fld_joint_s_* finite on all 944 filled replicates                      PASS     
  complement field filled on 944 of 944 declared replicates (0 notes)
  invariant harm  : fld_H_lo1s <= fld_H_est2                             PASS     
  invariant compl : fld_Hc_est2 <= fld_Hc_up1s                           PASS     
  invariant _s    : fld_Hc_lo1s_s <= fld_Hc_up1s_s                       PASS     
  invariant _s    : fld_Hc_lo2s_s <= fld_Hc_hi2s_s                       PASS     
  ...
  no NEGATIVE bound (33 columns)                                         PASS     
  >> DEGENERATE BOUNDS (separation) : none | oracle rows affected: H 0, Hc 0 of 1000
  gamma (joint)   in [0.025, 0.05]                                       PASS     [0.02500, 0.02600]
  gamma (joint-s) in [0.025, 0.05]                                       PASS     [0.02500, 0.02700]
  identity: field-s inverted around the same beta-tilde^c (log scale)    PASS     max |diff| = 3.33e-16
  identity: log(est2) + lambda_mean = log(beta-tilde^c), field and field-s PASS     max |diff| = 2.22e-16
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (944 of 944 agree; max |diff| 0)
  identity: log(lo1s) = log(beta-tilde) - q95; log(up1s) = log(beta-tilde^c) - q05 PASS     max |diff| = 2.22e-16
  C_dagger_* / C_ddagger_* equal the truth table on every row            PASS     
  >> p-hat(H): mean 0.183, share < 0.5: 0.958 | CLASSIFICATION: sens 0.2066 ppv 0.1766 | mean |Hhat| 86.7
  >> BOUNDS: mean fld_H_lo1s 0.4545 | share >= 1.0 0.017 | mean fld_Hc_up1s_s 0.8938 | share <= 1.0 0.750
  orfs comparator on disk                                                PASS     fs_effMaxSG_mr_field_or075_n500_nb20_orfs_combined_1_1000.rds
  --- same draws as orfs: ordina -> orfs ---
  [ordina -> orfs] same sim_id set (1000 rows)                           PASS     (comparator 1000 rows)
  [ordina -> orfs] the data-level columns (10: seed, n_true, the 8 oracle columns) <= 1e-08 relative PASS     (max 1.69e-14)
  [ordina -> orfs] seed identical() on all rows                          PASS     
  [ordina -> orfs] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  --- same draws as orfs: orfs -> ordina ---
  [orfs -> ordina] same sim_id set (1000 rows)                           PASS     (comparator 1000 rows)
  [orfs -> ordina] the data-level columns (10: seed, n_true, the 8 oracle columns) <= 1e-08 relative PASS     (max 1.69e-14)
  [orfs -> ordina] seed identical() on all rows                          PASS     
  [orfs -> ordina] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  orfs comparator (same cell): declaration 0.7810 | mean |Hhat| 101.7 | mean fld_H_lo1s 0.3434
  size <= 100 MB: dina_effMaxSG_mr_field_or075_n500_nb20_ordina_res_1_1000.rds PASS     (769059 B)
  size <= 100 MB: dina_effMaxSG_mr_field_or075_n500_nb20_ordina_combined_1_1000.rds PASS     (769241 B)
  timing: fit_mr_secs mean 13.6 median 9.7 p90 29.3 max 71.6 | id_secs mean 0.97 median 0.48 max 7.87 | fld_H_secs mean 11.7 | fld_Hc_secs mean 0.27

GATE_COUNTS run=88 passed=88 failed=0
```

## ordina_or100_n500 — identifier dina, target_or_h 1.0, n 500

- Stem: `dina_effMaxSG_mr_field_or100_n500_nb20_ordina`; HEAD before this cell's commit: 8df8a029; workers 13; threads 1.
- Knobs: `FS_OR_METHOD=dina FS_OR_FOCUS=effMaxSG FS_OR_NBHD=0.20 FS_OR_RULE=neighborhood FS_OR_CI=field FS_OR_FIELD_SCALEC=selected FS_OR_CAMPAIGN=ordina FS_OR_TARGET=1.0 FS_OR_N=500 FS_OR_WORKERS=13`.
- Seeds: the study's pre-generated table indexed by global sim_id (seed_base 8316951); one batch, sim_id 1-1000, then combine.
- Replicates: 1000 (TASK_binary_launch_v2_2026-09-18; the superseded 2 x 1,000 layout is not used).
- Package: R 4.5.2; ; 2026-09-19 20:23:40 UTC; unix.
- Cell wall: 1539 s; cumulative render wall 1538 s (ceiling 440000 s).
- Render: WALL_SECONDS=1523 RC=0 PEAK_MB=17686 OUT=dina_effMaxSG_mr_field_or100_n500_nb20_ordina_batch_1_1000.html
- Render: WALL_SECONDS=15 RC=0 PEAK_MB=1715 OUT=dina_effMaxSG_mr_field_or100_n500_nb20_ordina_combine_1_1000.html
- Gate counts: `GATE_COUNTS run=88 passed=88 failed=0`.

```

########## GATE 2 (ordina): ordina_or100_n500 -- target_or_h 1.0, n 500, identifier dina ##########
  Every coverage figure of this campaign is coverage of beta(H-hat) CONDITIONAL ON THE PROPOSED FAMILY.
  bundle: ../mr_or_harm/dina_effMaxSG_mr_field_or100_n500_nb20_ordina_d5000/dina_effMaxSG_mr_field_or100_n500_nb20_ordina_combined_1_1000.rds
  combined payload on disk                                               PASS     
  --- combine assertions ---
  exactly 1 batch file, res_1_1000                                       PASS     (1)
  1,000 rows                                                             PASS     (1000)
  ...
  meta: n_workers == 13                                                  PASS     (13)
  meta carries the truths                                                PASS     (marg_H 0.9999999999 | marg_Hc 0.6564077470 | cde_H 0.9999999999 | cde_Hc 0.6313905111 | prev 0.149170)
  meta seed_base 8316951 | seed_scheme pre-generated table indexed by global sim_id | host Mac-Studio-3.local | R 4.5.2 | pkg_commit 8df8a029 | built_at 2026-09-19 16:41:58
  --- launch record (combined meta) ---
  meta: n_sims == 1000                                                   PASS     (1000)
  meta: Stage 0 feasibility gate green, not overridden                   PASS     (feasible TRUE, override FALSE, tol 0.05, shares n500=0.015|n750=0.000|n1000=0.000|n2000=0.000)
  meta: the oracle helper assertion passed in the render                 PASS     (TRUE)
  meta: wall clock recorded                                              PASS     (1438 s total; by batch 1438)
  meta: the non-estimable / NA-oracle counts recorded                    PASS     (n_na_oracle_H=0, n_na_oracle_Hc=0, n_nonestimable_H=0, n_nonestimable_Hc=0)
  >> NA-ORACLE (true region)  : H 0 / 1000, Hc 0 / 1000
  >> NON-ESTIMABLE (selected) : H 0, Hc 0 (of the declared replicates)
  >> PREVALENCE(H) / sg_quantile: 0.149170 / 0.62850 | pkg 0.3.5.9000 built 2026-09-19 16:41:58 | workers 13
  >> DECLARATION RATE         : 0.9680 (968 / 1000)
  MR failures on declared replicates <= 40                               PASS     (0)
  >> N_FAMILY (MR's kept family K): min 1  med 540  p90 2842  max 6082
  >> ADMITTED_N               : min 1  q25 96  MED 309.5  q75 832.5  p90 1743  max 5259  (mean 651.1, n 968); == 0 on 0 row(s)
  >> DINA_PROPOSED_N          : min 1  q25 192  MED 540  q75 1406.75  p90 2842  max 6082  (mean 1052.7, n 968); searched 7780-8498
  DINA proposal fields filled on every declared replicate                PASS     (dina_searched_n 968/968, dina_proposed_n 968/968, dina_tau_min 968/968, admitted_n 968/968)
  every proposed candidate at oriented tau-hat >= log(0.90), the OR effect threshold on the harm side PASS     (min -0.10536027 = OR 0.900000; floor log(0.90) = -0.10536052)
  1 <= admitted_n <= dina_proposed_n on every declared replicate         PASS     
  STRUCTURAL n_cons_qual  present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  STRUCTURAL band_n       present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  n_family finite on every declared replicate with a gate                PASS     
  ...
  zero factor-comparison warnings                                        PASS     
  every finiteness column present (incl. C_dagger_* / C_ddagger_*)       PASS     
  harm products finite on declared replicates with a field block         PASS     (968 rows)
  nine fld_Hc_*_s and nine fld_joint_s_* columns present                 PASS     
  fld_Hc_*_s finite on all 968 filled replicates                         PASS     
  fld_joint_s_* finite on all 968 filled replicates                      PASS     
  complement field filled on 968 of 968 declared replicates (0 notes)
  invariant harm  : fld_H_lo1s <= fld_H_est2                             PASS     
  invariant compl : fld_Hc_est2 <= fld_Hc_up1s                           PASS     
  invariant _s    : fld_Hc_lo1s_s <= fld_Hc_up1s_s                       PASS     
  invariant _s    : fld_Hc_lo2s_s <= fld_Hc_hi2s_s                       PASS     
  ...
  identity: field-s inverted around the same beta-tilde^c (log scale)    PASS     max |diff| = 3.33e-16
  identity: log(est2) + lambda_mean = log(beta-tilde^c), field and field-s PASS     max |diff| = 2.22e-16
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (968 of 968 agree; max |diff| 0)
  identity: log(lo1s) = log(beta-tilde) - q95; log(up1s) = log(beta-tilde^c) - q05 PASS     max |diff| = 2.22e-16
  C_dagger_* / C_ddagger_* equal the truth table on every row            PASS     
  >> p-hat(H): mean 0.175, share < 0.5: 0.955 | CLASSIFICATION: sens 0.2431 ppv 0.2099 | mean |Hhat| 86.1
  >> BOUNDS: mean fld_H_lo1s 0.4729 | share >= 1.0 0.022 | mean fld_Hc_up1s_s 0.9314 | share <= 1.0 0.676
  orfs comparator on disk                                                PASS     fs_effMaxSG_mr_field_or100_n500_nb20_orfs_combined_1_1000.rds
  --- same draws as orfs: ordina -> orfs ---
  [ordina -> orfs] same sim_id set (1000 rows)                           PASS     (comparator 1000 rows)
  [ordina -> orfs] the data-level columns (10: seed, n_true, the 8 oracle columns) <= 1e-08 relative PASS     (max 1.69e-14)
  ...
  [orfs -> ordina] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  orfs comparator (same cell): declaration 0.8520 | mean |Hhat| 101.3 | mean fld_H_lo1s 0.3634
  size <= 100 MB: dina_effMaxSG_mr_field_or100_n500_nb20_ordina_res_1_1000.rds PASS     (781574 B)
  size <= 100 MB: dina_effMaxSG_mr_field_or100_n500_nb20_ordina_combined_1_1000.rds PASS     (781648 B)
  timing: fit_mr_secs mean 16.4 median 11.3 p90 36.1 max 75.1 | id_secs mean 1.24 median 0.63 max 7.26 | fld_H_secs mean 13.7 | fld_Hc_secs mean 0.31

GATE_COUNTS run=88 passed=88 failed=0
```

## ordina_or075_n2000 — identifier dina, target_or_h 0.75, n 2000

- Stem: `dina_effMaxSG_mr_field_or075_n2000_nb20_ordina`; HEAD before this cell's commit: d4b87a5a; workers 13; threads 1.
- Knobs: `FS_OR_METHOD=dina FS_OR_FOCUS=effMaxSG FS_OR_NBHD=0.20 FS_OR_RULE=neighborhood FS_OR_CI=field FS_OR_FIELD_SCALEC=selected FS_OR_CAMPAIGN=ordina FS_OR_TARGET=0.75 FS_OR_N=2000 FS_OR_WORKERS=13`.
- Seeds: the study's pre-generated table indexed by global sim_id (seed_base 8316951); one batch, sim_id 1-1000, then combine.
- Replicates: 1000 (TASK_binary_launch_v2_2026-09-18; the superseded 2 x 1,000 layout is not used).
- Package: R 4.5.2; ; 2026-09-19 20:23:40 UTC; unix.
- Cell wall: 733 s; cumulative render wall 733 s (ceiling 440000 s).
- Render: WALL_SECONDS=717 RC=0 PEAK_MB=18081 OUT=dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_batch_1_1000.html
- Render: WALL_SECONDS=16 RC=0 PEAK_MB=1642 OUT=dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_combine_1_1000.html
- Gate counts: `GATE_COUNTS run=88 passed=88 failed=0`.

```

########## GATE 2 (ordina): ordina_or075_n2000 -- target_or_h 0.75, n 2000, identifier dina ##########
  Every coverage figure of this campaign is coverage of beta(H-hat) CONDITIONAL ON THE PROPOSED FAMILY.
  bundle: ../mr_or_harm/dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_d5000/dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_combined_1_1000.rds
  combined payload on disk                                               PASS     
  --- combine assertions ---
  exactly 1 batch file, res_1_1000                                       PASS     (1)
  1,000 rows                                                             PASS     (1000)
  ...
  meta: n_workers == 13                                                  PASS     (13)
  meta carries the truths                                                PASS     (marg_H 0.7499999940 | marg_Hc 0.6564077470 | cde_H 0.7345268290 | cde_Hc 0.6313905111 | prev 0.149170)
  meta seed_base 8316951 | seed_scheme pre-generated table indexed by global sim_id | host Mac-Studio-3.local | R 4.5.2 | pkg_commit d4b87a5a | built_at 2026-09-19 16:54:16
  --- launch record (combined meta) ---
  meta: n_sims == 1000                                                   PASS     (1000)
  meta: Stage 0 feasibility gate green, not overridden                   PASS     (feasible TRUE, override FALSE, tol 0.05, shares n500=0.015|n750=0.000|n1000=0.000|n2000=0.000)
  meta: the oracle helper assertion passed in the render                 PASS     (TRUE)
  meta: wall clock recorded                                              PASS     (639 s total; by batch 639)
  meta: the non-estimable / NA-oracle counts recorded                    PASS     (n_na_oracle_H=0, n_na_oracle_Hc=0, n_nonestimable_H=0, n_nonestimable_Hc=0)
  >> NA-ORACLE (true region)  : H 0 / 1000, Hc 0 / 1000
  >> NON-ESTIMABLE (selected) : H 0, Hc 0 (of the declared replicates)
  >> PREVALENCE(H) / sg_quantile: 0.149170 / 0.62850 | pkg 0.3.5.9000 built 2026-09-19 16:54:16 | workers 13
  >> DECLARATION RATE         : 0.8700 (870 / 1000)
  MR failures on declared replicates <= 40                               PASS     (0)
  >> N_FAMILY (MR's kept family K): min 1  med 130  p90 614.2  max 2836
  >> ADMITTED_N               : min 1  q25 19  MED 75  q75 204.5  p90 417.1  max 2466  (mean 160.6, n 870); == 0 on 0 row(s)
  >> DINA_PROPOSED_N          : min 1  q25 42  MED 130  q75 327.75  p90 614.2  max 2836  (mean 253.0, n 870); searched 9560-10126
  DINA proposal fields filled on every declared replicate                PASS     (dina_searched_n 870/870, dina_proposed_n 870/870, dina_tau_min 870/870, admitted_n 870/870)
  every proposed candidate at oriented tau-hat >= log(0.90), the OR effect threshold on the harm side PASS     (min -0.10535922 = OR 0.900001; floor log(0.90) = -0.10536052)
  1 <= admitted_n <= dina_proposed_n on every declared replicate         PASS     
  STRUCTURAL n_cons_qual  present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  STRUCTURAL band_n       present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  n_family finite on every declared replicate with a gate                PASS     
  ...
  zero factor-comparison warnings                                        PASS     
  every finiteness column present (incl. C_dagger_* / C_ddagger_*)       PASS     
  harm products finite on declared replicates with a field block         PASS     (870 rows)
  nine fld_Hc_*_s and nine fld_joint_s_* columns present                 PASS     
  fld_Hc_*_s finite on all 870 filled replicates                         PASS     
  fld_joint_s_* finite on all 870 filled replicates                      PASS     
  complement field filled on 870 of 870 declared replicates (0 notes)
  invariant harm  : fld_H_lo1s <= fld_H_est2                             PASS     
  invariant compl : fld_Hc_est2 <= fld_Hc_up1s                           PASS     
  invariant _s    : fld_Hc_lo1s_s <= fld_Hc_up1s_s                       PASS     
  invariant _s    : fld_Hc_lo2s_s <= fld_Hc_hi2s_s                       PASS     
  ...
  identity: field-s inverted around the same beta-tilde^c (log scale)    PASS     max |diff| = 2.22e-16
  identity: log(est2) + lambda_mean = log(beta-tilde^c), field and field-s PASS     max |diff| = 2.22e-16
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (870 of 870 agree; max |diff| 0)
  identity: log(lo1s) = log(beta-tilde) - q95; log(up1s) = log(beta-tilde^c) - q05 PASS     max |diff| = 2.22e-16
  C_dagger_* / C_ddagger_* equal the truth table on every row            PASS     
  >> p-hat(H): mean 0.242, share < 0.5: 0.895 | CLASSIFICATION: sens 0.0676 ppv 0.1856 | mean |Hhat| 109.0
  >> BOUNDS: mean fld_H_lo1s 0.4648 | share >= 1.0 0.018 | mean fld_Hc_up1s_s 0.7760 | share <= 1.0 0.997
  orfs comparator on disk                                                PASS     fs_effMaxSG_mr_field_or075_n2000_nb20_orfs_combined_1_1000.rds
  --- same draws as orfs: ordina -> orfs ---
  [ordina -> orfs] same sim_id set (1000 rows)                           PASS     (comparator 1000 rows)
  ...
  [orfs -> ordina] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  orfs comparator (same cell): declaration 0.9100 | mean |Hhat| 138.9 | mean fld_H_lo1s 0.3395
  size <= 100 MB: dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_res_1_1000.rds PASS     (723710 B)
  size <= 100 MB: dina_effMaxSG_mr_field_or075_n2000_nb20_ordina_combined_1_1000.rds PASS     (723896 B)
  timing: fit_mr_secs mean 7.4 median 6.7 p90 13.2 max 43.0 | id_secs mean 0.45 median 0.29 max 4.83 | fld_H_secs mean 6.6 | fld_Hc_secs mean 0.22
...
## ordina_or150_n2000 — identifier dina, target_or_h 1.5, n 2000

- Stem: `dina_effMaxSG_mr_field_or150_n2000_nb20_ordina`; HEAD before this cell's commit: 699254af; workers 13; threads 1.
- Knobs: `FS_OR_METHOD=dina FS_OR_FOCUS=effMaxSG FS_OR_NBHD=0.20 FS_OR_RULE=neighborhood FS_OR_CI=field FS_OR_FIELD_SCALEC=selected FS_OR_CAMPAIGN=ordina FS_OR_TARGET=1.5 FS_OR_N=2000 FS_OR_WORKERS=13`.
- Seeds: the study's pre-generated table indexed by global sim_id (seed_base 8316951); one batch, sim_id 1-1000, then combine.
- Replicates: 1000 (TASK_binary_launch_v2_2026-09-18; the superseded 2 x 1,000 layout is not used).
- Package: R 4.5.2; ; 2026-09-19 20:23:40 UTC; unix.
- Cell wall: 1690 s; cumulative render wall 1690 s (ceiling 440000 s).
- Render: WALL_SECONDS=1675 RC=0 PEAK_MB=17852 OUT=dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_batch_1_1000.html
- Render: WALL_SECONDS=15 RC=0 PEAK_MB=1813 OUT=dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_combine_1_1000.html
- Gate counts: `GATE_COUNTS run=88 passed=88 failed=0`.

```

########## GATE 2 (ordina): ordina_or150_n2000 -- target_or_h 1.5, n 2000, identifier dina ##########
  Every coverage figure of this campaign is coverage of beta(H-hat) CONDITIONAL ON THE PROPOSED FAMILY.
  bundle: ../mr_or_harm/dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_d5000/dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_combined_1_1000.rds
  combined payload on disk                                               PASS     
  --- combine assertions ---
  exactly 1 batch file, res_1_1000                                       PASS     (1)
  1,000 rows                                                             PASS     (1000)
  ...
  meta: n_workers == 13                                                  PASS     (13)
  meta carries the truths                                                PASS     (marg_H 1.5000000002 | marg_Hc 0.6564077470 | cde_H 1.5414142152 | cde_Hc 0.6313905111 | prev 0.149170)
  meta seed_base 8316951 | seed_scheme pre-generated table indexed by global sim_id | host Mac-Studio-3.local | R 4.5.2 | pkg_commit 699254af | built_at 2026-09-19 17:39:12
  --- launch record (combined meta) ---
  meta: n_sims == 1000                                                   PASS     (1000)
  meta: Stage 0 feasibility gate green, not overridden                   PASS     (feasible TRUE, override FALSE, tol 0.05, shares n500=0.015|n750=0.000|n1000=0.000|n2000=0.000)
  meta: the oracle helper assertion passed in the render                 PASS     (TRUE)
  meta: wall clock recorded                                              PASS     (1591 s total; by batch 1591)
  meta: the non-estimable / NA-oracle counts recorded                    PASS     (n_na_oracle_H=0, n_na_oracle_Hc=0, n_nonestimable_H=0, n_nonestimable_Hc=0)
  >> NA-ORACLE (true region)  : H 0 / 1000, Hc 0 / 1000
  >> NON-ESTIMABLE (selected) : H 0, Hc 0 (of the declared replicates)
  >> PREVALENCE(H) / sg_quantile: 0.149170 / 0.62850 | pkg 0.3.5.9000 built 2026-09-19 17:39:12 | workers 13
  >> DECLARATION RATE         : 0.9870 (987 / 1000)
  MR failures on declared replicates <= 40                               PASS     (0)
  >> N_FAMILY (MR's kept family K): min 3  med 662  p90 2034  max 6987
  >> ADMITTED_N               : min 1  q25 201  MED 478  q75 909.5  p90 1477.4  max 5404  (mean 689.6, n 987); == 0 on 0 row(s)
  >> DINA_PROPOSED_N          : min 3  q25 335  MED 662  q75 1227  p90 2034  max 6987  (mean 947.1, n 987); searched 9560-10126
  DINA proposal fields filled on every declared replicate                PASS     (dina_searched_n 987/987, dina_proposed_n 987/987, dina_tau_min 987/987, admitted_n 987/987)
  every proposed candidate at oriented tau-hat >= log(0.90), the OR effect threshold on the harm side PASS     (min -0.10536051 = OR 0.900000; floor log(0.90) = -0.10536052)
  1 <= admitted_n <= dina_proposed_n on every declared replicate         PASS     
  STRUCTURAL n_cons_qual  present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  STRUCTURAL band_n       present, all-NA -- STRUCTURAL (no consistency screen) on dina, NOT a failure
  ...
  zero factor-comparison warnings                                        PASS     
  every finiteness column present (incl. C_dagger_* / C_ddagger_*)       PASS     
  harm products finite on declared replicates with a field block         PASS     (987 rows)
  nine fld_Hc_*_s and nine fld_joint_s_* columns present                 PASS     
  fld_Hc_*_s finite on all 987 filled replicates                         PASS     
  fld_joint_s_* finite on all 987 filled replicates                      PASS     
  complement field filled on 987 of 987 declared replicates (0 notes)
  invariant harm  : fld_H_lo1s <= fld_H_est2                             PASS     
  invariant compl : fld_Hc_est2 <= fld_Hc_up1s                           PASS     
  invariant _s    : fld_Hc_lo1s_s <= fld_Hc_up1s_s                       PASS     
  invariant _s    : fld_Hc_lo2s_s <= fld_Hc_hi2s_s                       PASS     
  ...
  identity: field-s inverted around the same beta-tilde^c (log scale)    PASS     max |diff| = 2.22e-16
  identity: log(est2) + lambda_mean = log(beta-tilde^c), field and field-s PASS     max |diff| = 2.22e-16
  identity: Bonferroni harm bound joint == joint_s where draw counts agree PASS     (987 of 987 agree; max |diff| 0)
  identity: log(lo1s) = log(beta-tilde) - q95; log(up1s) = log(beta-tilde^c) - q05 PASS     max |diff| = 2.22e-16
  C_dagger_* / C_ddagger_* equal the truth table on every row            PASS     
  >> p-hat(H): mean 0.188, share < 0.5: 0.959 | CLASSIFICATION: sens 0.2073 ppv 0.5121 | mean |Hhat| 115.1
  >> BOUNDS: mean fld_H_lo1s 0.5808 | share >= 1.0 0.070 | mean fld_Hc_up1s_s 0.8512 | share <= 1.0 0.956
  orfs comparator on disk                                                PASS     fs_effMaxSG_mr_field_or150_n2000_nb20_orfs_combined_1_1000.rds
  --- same draws as orfs: ordina -> orfs ---
  [ordina -> orfs] same sim_id set (1000 rows)                           PASS     (comparator 1000 rows)
  [ordina -> orfs] the data-level columns (10: seed, n_true, the 8 oracle columns) <= 1e-08 relative PASS     (max 4.5e-14)
  ...
  [orfs -> ordina] the truths (or_causal,marg_H,marg_Hc,cde_H,cde_Hc,prevalence_Q,beta_inter) <= 1e-08 relative PASS     (max 7.07e-15)
  orfs comparator (same cell): declaration 0.9980 | mean |Hhat| 137.5 | mean fld_H_lo1s 0.4917
  size <= 100 MB: dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_res_1_1000.rds PASS     (777455 B)
  size <= 100 MB: dina_effMaxSG_mr_field_or150_n2000_nb20_ordina_combined_1_1000.rds PASS     (777509 B)
  timing: fit_mr_secs mean 18.3 median 15.1 p90 33.3 max 95.9 | id_secs mean 1.55 median 1.03 max 14.67 | fld_H_secs mean 13.9 | fld_Hc_secs mean 0.58
