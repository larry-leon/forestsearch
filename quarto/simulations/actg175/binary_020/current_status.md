...
- **Pin:** `d356bd8a` on `feature/glm-extension` — HEAD at the time this file was committed; the closeout commit that adds this file is its child.
...
| `REPORT_*.md` | 8/8 | 177 KB | `REPORT_criterion_and_defaults_audit_2026-09-18.md` 54 KB | other REPORT documents |
| `LOG_or_progress.txt` | 1/1 | 14 KB | `LOG_or_progress.txt` 14 KB | per-render heartbeat |
| `current_status.md` | 1/1 | 26 KB | `current_status.md` 26 KB | this file -- the directory's catalog at a pin |
| `status_curated.md` | 1/1 | 16 KB | `status_curated.md` 16 KB | the hand-maintained sections of `current_status.md` |
...
| **all** | **141/245** | **209.38 MB** | `dina_effMaxSG_mr_field_or075_n500_nb20_ordina_batch_1_1000.html` 3.88 MB | |
