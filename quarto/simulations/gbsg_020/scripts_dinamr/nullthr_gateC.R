#!/usr/bin/env Rscript
# GATE C -- nullc125 (TASK_null_gbsg_thresholds_2026-09-21_v2), one per cell:
# the three identifiers ran on IDENTICAL draws.
#
...
path <- function(tag)
  sprintf("results/%s_effMaxSG_fb_mr_field_m1_h%03d_knoise0_n%d_null%03d_nb20_nomr%s_%s%s_res_1_%d.rds",
