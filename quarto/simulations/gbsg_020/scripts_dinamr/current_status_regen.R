...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-13 (closeout of the merge that brought the pop-os line — `TASK_p12x20_partA_2026-09-12_v2`, `TASK_p12x20_merge_2026-09-13`, `TASK_status_curated_restore_2026-09-13` — together with the Mac's `TASK_idsweep_2026-09-12`; curated sections from `status_curated.md`, reconciled for both).",
