...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-23 (closeout of `TASK_gbsg_app_null_declaration_2026-09-23` \u2014 catalogue pointer only, \u00a72.12: the sibling `gbsg_app_null` run lives in `quarto/simulations/gbsg_app_null/`, not in this directory; curated sections from `status_curated.md`).",
