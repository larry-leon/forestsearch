...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-22 (closeout of `TASK_declcal_c0_campaign_2026-09-22` \u2014 the `declcal` B and C blocks re-run with the clinically specified null level `declaration_c0` = 0.70 / 0.75 / 0.80 / 0.85, campaign `declcalc0`, \u00a72.11: FS only, c1 = c2 = 1.0, 10 cells \u00d7 2,000 replicates on the `declcal` seeds, identity-gated against the committed `declcal` payloads; curated sections from `status_curated.md`).",
