...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-21 (closeout of `TASK_null_gbsg_mr_2026-09-21` \u2014 the structural null at the `nullid` screen c1 0.90 / c2 0.80 with MR post-selection inference, `nullmr`, \u00a72.10: 6 cells \u00d7 3 identifiers \u00d7 2,000 replicates, MR on, no full bootstrap; curated sections from `status_curated.md`).",
