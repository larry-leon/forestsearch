...
camps <- list(
  ...
  declcal = list(bdir = "results", bre = "^declcal_(bnull|inull|power)_[A-C][0-9]_res_1_2000[.]rds$",
                ...
                scripts = "scripts_dinamr", sre = "declcal",
...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-22 (closeout of `TASK_declcal_CAMPAIGN_2026-09-22_v2` \u2014 the declaration-calibration finite-sample evaluation, `declcal`, \u00a72.11: FS only, c1 = c2 = 1.0, 13 cells \u00d7 2,000 replicates (boundary null, interior null, planted-harm power), the calibrated and conventional screens evaluated post hoc on one search per replicate; curated sections from `status_curated.md`).",
