...
L <- c(sprintf("# current_status — `%s`", rq), "",
  ...
  "- **Updated:** 2026-09-23 (closeout of `TASK_mr_alignment_section5_sweep_2026-09-23`, with `TASK_mr_alignment_section5_probe_2026-09-23`: \u00a72.13, campaign `mrs5`; curated sections from `status_curated.md`).",
