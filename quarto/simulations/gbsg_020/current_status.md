...
- **Pin:** `48a2cca2` on `feature/glm-extension` — HEAD at the time this file was committed; the closeout commit that adds this file is its child.
...
| `scripts_dinamr/*.R` | 35/35 | 273 KB | `gate2G.R` 17 KB | drivers, checkers, projections, extractions (R) |
...
| `REPORT_*.md` | 71/71 | 1.20 MB | `REPORT_fixedphat_ij2s_2026-09-09.md` 79 KB | REPORT documents |
...
| `current_status.md` | 1/1 | 52 KB | `current_status.md` 52 KB | this file -- the directory's catalog at a pin |
| `*.md` | 2/2 | 30 KB | `status_curated.md` 28 KB | other notes in the directory |
...
| **total** | **2860/2863** | **3422 MB** | `summary_grfmr.html` 7.87 MB | every file, each counted once |
