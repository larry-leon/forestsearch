...
- **Pin:** `ea74b1b0` on `feature/glm-extension` — HEAD at the time this file was committed; the closeout commit that adds this file is its child.
...
| `scripts_dinamr/*.R` | 31/31 | 220 KB | `gate2G.R` 17 KB | drivers, checkers, projections, extractions (R) |
...
| `current_status.md` | 1/1 | 40 KB | `current_status.md` 40 KB | this file -- the directory's catalog at a pin |
| `*.md` | 2/2 | 22 KB | `status_curated.md` 20 KB | other notes in the directory |
...
| **total** | **1668/1671** | **2308 MB** | `summary_grfmr.html` 7.87 MB | every file, each counted once |
