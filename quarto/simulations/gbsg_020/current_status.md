...
- **Pin:** `6ce92a52` on `feature/glm-extension` — HEAD at the time this file was committed; the closeout commit that adds this file is its child.
...
| `REPORT_*.md` | 70/70 | 1.18 MB | `REPORT_fixedphat_ij2s_2026-09-09.md` 79 KB | REPORT documents |
...
| `*.md` | 2/2 | 29 KB | `status_curated.md` 27 KB | other notes in the directory |
...
| **total** | **2859/2859** | **3422 MB** | `summary_grfmr.html` 7.87 MB | every file, each counted once |
