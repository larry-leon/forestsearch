...
- **Pin:** `5a1fa998` on `feature/glm-extension` — HEAD at the time this file was committed; the closeout commit that adds this file is its child.
...
| **total** | **2964/2964** | **3511 MB** | `summary_grfmr.html` 7.87 MB | every file, each counted once |
