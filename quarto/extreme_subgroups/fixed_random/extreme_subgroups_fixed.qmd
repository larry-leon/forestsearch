...
if (isTRUE(save_payload)) {
  payload <- list(
    design               = design_label,          # "resample" | "fixed"
    n_sims               = n_sims_uniform,
    sim_hrs              = sim_hrs,               # n_sims x n_subgroups
    sim_ubs              = sim_ubs,
    sim_ns               = sim_ns,
    subgroups            = subgroups,             # list(id, name, grp)
    sim_config           = sim_config,
    cens_adjust          = cal_uniform$cens_adjust,
    k_treat              = k_treat_uniform,
    hr_true              = 0.70,                  # AHR calibration target
    created              = Sys.time(),
