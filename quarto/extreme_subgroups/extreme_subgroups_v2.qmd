...
timing_df <- data.frame(
  Step = c(
    ...
    sprintf("Simulation loop (%d trials \u00d7 %d subgroups)",
            n_sims_null, length(subgroups)),
    "Total"
  ),
...
knitr::kable(timing_df,
             align   = c("l", "r", "r"),
             caption = sprintf("Timing for n_sims_null = %d on this machine.",
                               n_sims_null))

cat(sprintf(
  "\nThroughput: %.1f trials/sec  |  Projected total time:  1,000 sims \u2192 %s    \u2502    5,000 sims \u2192 %s\n",
  trials_per_s, proj_for(1000), proj_for(5000)
))
```
