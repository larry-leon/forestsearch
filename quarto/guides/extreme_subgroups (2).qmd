...
cat("Median follow-up, naive (months):",
...
\qquad \varepsilon_i \sim \mathrm{Gumbel}(0, 1).
$$
...
cat("Uniform DGM  |  true overall HR:",
...
With true overall HR = 0.70, every subgroup — regardless of how it is
...
results_hte <- data.frame(
  ...
  True_HR     = round(c(dgm_hte$hazard_ratios$overall,
