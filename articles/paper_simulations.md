...
```
    ...
    ## Seconds and minutes forestsearch overall = 17.542 0.2924 
...
```
    ...
    ## No subgroups found meeting consistency threshold
    ## Seconds and minutes forestsearch overall = 11.153 0.1859 
    ## Consistency algorithm used: twostage 
...
| Calibrate k_inter (Cox)                                 | 7.6         | 0.13       | 1.6        |
| Calibrate k_inter (AHR)                                 | 3.3         | 0.05       | 0.7        |
| Validate k_inter                                        | 0.7         | 0.01       | 0.1        |
| DGM creation (H0)                                       | 0.1         | 0.00       | 0.0        |
| Simulations H1                                          | 235.3       | 3.92       | 49.2       |
| Simulations H0                                          | 193.8       | 3.23       | 40.5       |
| Summarize H1                                            | 0.2         | 0.00       | 0.0        |
| Summarize H0                                            | 0.1         | 0.00       | 0.0        |
| Total vignette                                          | 478.0       | 7.97       | 100.0      |
...
```
    ...
    ##   H1: 4.8 sec/sim (wall) across 49 sims on 3 workers
...
```
    ...
    ##   H0: 4.0 sec/sim (wall) across 49 sims on 3 workers
