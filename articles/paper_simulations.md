...
```
    ...
    ## Seconds and minutes forestsearch overall = 18.298 0.305 
...
```
    ...
    ## No subgroups found meeting consistency threshold
    ## Seconds and minutes forestsearch overall = 10.064 0.1677 
    ## Consistency algorithm used: twostage 
...
| Simulations H1                                          | 216.5       | 3.61       | 48.3       |
| Simulations H0                                          | 183.1       | 3.05       | 40.9       |
| Summarize H1                                            | 0.2         | 0.00       | 0.0        |
| Summarize H0                                            | 0.1         | 0.00       | 0.0        |
| Total vignette                                          | 448.2       | 7.47       | 100.0      |
...
```
    ...
    ##   H1: 4.4 sec/sim (wall) across 49 sims on 3 workers
...
```
    ...
    ##   H0: 3.7 sec/sim (wall) across 49 sims on 3 workers
