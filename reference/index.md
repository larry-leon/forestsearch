...
- [`print(`*`<forestsearch>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.forestsearch.md)
...
- [`subgroup.search()`](https://github.com/larry-leon/forestsearch/reference/subgroup.search.md)
  : Subgroup Search for Treatment Effect Heterogeneity (Improved,
  Parallelized)
- [`get_FSdata()`](https://github.com/larry-leon/forestsearch/reference/get_FSdata.md)
...
- [`analyze_subgroup()`](https://github.com/larry-leon/forestsearch/reference/analyze_subgroup.md)
  : Analyze subgroup for summary table (OPTIMIZED)
- [`assign_subgroup_membership()`](https://github.com/larry-leon/forestsearch/reference/assign_subgroup_membership.md)
  : Assign data to subgroups based on selected node
- [`evaluate_subgroup_consistency()`](https://github.com/larry-leon/forestsearch/reference/evaluate_subgroup_consistency.md)
  : Evaluate Single Subgroup for Consistency (Fixed-Sample)
- [`extract_subgroup()`](https://github.com/larry-leon/forestsearch/reference/extract_subgroup.md)
  : Extract Subgroup Information
- [`get_subgroup_membership()`](https://github.com/larry-leon/forestsearch/reference/get_subgroup_membership.md)
  : Get subgroup membership vector
- [`prepare_subgroup_data()`](https://github.com/larry-leon/forestsearch/reference/prepare_subgroup_data.md)
  : Prepare subgroup data for analysis
- [`select_best_subgroup()`](https://github.com/larry-leon/forestsearch/reference/select_best_subgroup.md)
  : Select best subgroup based on criterion
- [`sort_subgroups()`](https://github.com/larry-leon/forestsearch/reference/sort_subgroups.md)
  : Sort Subgroups by Focus
- [`sort_subgroups_preview()`](https://github.com/larry-leon/forestsearch/reference/sort_subgroups_preview.md)
  : Sort Subgroups by Focus at consistency stage (consistency not
  available at this point)
- [`remove_near_duplicate_subgroups()`](https://github.com/larry-leon/forestsearch/reference/remove_near_duplicate_subgroups.md)
  : Remove Near-Duplicate Subgroups
- [`remove_redundant_subgroups()`](https://github.com/larry-leon/forestsearch/reference/remove_redundant_subgroups.md)
...
- [`evaluate_consistency_twostage()`](https://github.com/larry-leon/forestsearch/reference/evaluate_consistency_twostage.md)
  : Evaluate Consistency (Two-Stage Algorithm)
- [`run_single_consistency_split()`](https://github.com/larry-leon/forestsearch/reference/run_single_consistency_split.md)
...
- [`wilson_ci()`](https://github.com/larry-leon/forestsearch/reference/wilson_ci.md)
  : Wilson Score Confidence Interval
- [`early_stop_decision()`](https://github.com/larry-leon/forestsearch/reference/early_stop_decision.md)
...
- [`count_boot_id()`](https://github.com/larry-leon/forestsearch/reference/count_boot_id.md)
  : Count ID Occurrences in Bootstrap Sample
- [`generate_bootstrap_synthetic()`](https://github.com/larry-leon/forestsearch/reference/generate_bootstrap_synthetic.md)
  : Generate Synthetic Data using Bootstrap with Perturbation
- [`generate_bootstrap_with_noise()`](https://github.com/larry-leon/forestsearch/reference/generate_bootstrap_with_noise.md)
  : Generate Bootstrap Sample with Added Noise
- [`generate_gbsg_bootstrap_general()`](https://github.com/larry-leon/forestsearch/reference/generate_gbsg_bootstrap_general.md)
...
- [`summarize_bootstrap_events()`](https://github.com/larry-leon/forestsearch/reference/summarize_bootstrap_events.md)
  : Summarize Bootstrap Event Counts
- [`summarize_factor_presence_robust()`](https://github.com/larry-leon/forestsearch/reference/summarize_factor_presence_robust.md)
...
- [`format_bootstrap_diagnostics_table()`](https://github.com/larry-leon/forestsearch/reference/format_bootstrap_diagnostics_table.md)
  : Format Bootstrap Diagnostics Table with gt
- [`format_bootstrap_timing_table()`](https://github.com/larry-leon/forestsearch/reference/format_bootstrap_timing_table.md)
...
- [`create_factor_summary_tables()`](https://github.com/larry-leon/forestsearch/reference/create_factor_summary_tables.md)
...
- [`CV_sgs()`](https://github.com/larry-leon/forestsearch/reference/CV_sgs.md)
...
- [`cv_summary_text()`](https://github.com/larry-leon/forestsearch/reference/cv_summary_text.md)
  : Create Compact CV Summary Text
- [`cv_compare_results()`](https://github.com/larry-leon/forestsearch/reference/cv_compare_results.md)
  : Compare Multiple CV Results
- [`print(`*`<fs_kfold>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_kfold.md)
  : Print Method for K-Fold CV Results
- [`print(`*`<fs_tenfold>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_tenfold.md)
...
- [`grf.subg.eval()`](https://github.com/larry-leon/forestsearch/reference/grf.subg.eval.md)
  : GRF Subgroup Evaluation and Performance Metrics
- [`fit_causal_forest()`](https://github.com/larry-leon/forestsearch/reference/fit_causal_forest.md)
  : Fit causal survival forest
- [`fit_policy_trees()`](https://github.com/larry-leon/forestsearch/reference/fit_policy_trees.md)
  : Fit policy trees up to specified depth
- [`create_grf_config()`](https://github.com/larry-leon/forestsearch/reference/create_grf_config.md)
  : Helper Functions for GRF Subgroup Analysis
- [`validate_grf_data()`](https://github.com/larry-leon/forestsearch/reference/validate_grf_data.md)
  : Validate input data for GRF analysis
- [`print_grf_details()`](https://github.com/larry-leon/forestsearch/reference/print_grf_details.md)
  : Print detailed output for debugging
- [`compute_node_metrics()`](https://github.com/larry-leon/forestsearch/reference/compute_node_metrics.md)
  : Compute node metrics for a policy tree
- [`find_leaf_split()`](https://github.com/larry-leon/forestsearch/reference/find_leaf_split.md)
...
- [`cox_summary()`](https://github.com/larry-leon/forestsearch/reference/cox_summary.md)
  : Cox model summary for subgroup (OPTIMIZED)
- [`cox_summary_batch()`](https://github.com/larry-leon/forestsearch/reference/cox_summary_batch.md)
  : Batch Cox summaries with caching
- [`cox_summary_legacy()`](https://github.com/larry-leon/forestsearch/reference/cox_summary_legacy.md)
  : Cox model summary for subgroup
- [`cox_summary_vectorized()`](https://github.com/larry-leon/forestsearch/reference/cox_summary_vectorized.md)
  : Cox model summary for subgroup - vectorized version
- [`cox_ahr_cde_analysis()`](https://github.com/larry-leon/forestsearch/reference/cox_ahr_cde_analysis.md)
  : Comprehensive Wrapper for Cox Spline Analysis with AHR and CDE
  Plotting
- [`print(`*`<cox_ahr_cde>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.cox_ahr_cde.md)
  : Print method for cox_ahr_cde objects
- [`summary(`*`<cox_ahr_cde>`*`)`](https://github.com/larry-leon/forestsearch/reference/summary.cox_ahr_cde.md)
  : Summary method for cox_ahr_cde objects
- [`cox_cs_fit()`](https://github.com/larry-leon/forestsearch/reference/cox_cs_fit.md)
...
- [`get_split_hr_fast()`](https://github.com/larry-leon/forestsearch/reference/get_split_hr_fast.md)
  : Fast Cox Model HR Estimation
- [`rmst_calculation()`](https://github.com/larry-leon/forestsearch/reference/rmst_calculation.md)
...
- [`SG_tab_estimates()`](https://github.com/larry-leon/forestsearch/reference/SG_tab_estimates.md)
  : Subgroup summary table estimates
- [`SGplot_estimates()`](https://github.com/larry-leon/forestsearch/reference/SGplot_estimates.md)
  : Violin/Boxplot Visualization of HR Estimates
- [`FS_labels()`](https://github.com/larry-leon/forestsearch/reference/FS_labels.md)
  : Convert Factor Code to Label
- [`create_summary_table()`](https://github.com/larry-leon/forestsearch/reference/create_summary_table.md)
  : Create Enhanced Summary Table for Baseline Characteristics
- [`create_summary_table_compact()`](https://github.com/larry-leon/forestsearch/reference/create_summary_table_compact.md)
  : Preset: Compact Table
- [`create_summary_table_minimal()`](https://github.com/larry-leon/forestsearch/reference/create_summary_table_minimal.md)
  : Preset: Minimal Table (No Highlighting, No Alternating)
- [`create_summary_table_presentation()`](https://github.com/larry-leon/forestsearch/reference/create_summary_table_presentation.md)
  : Preset: Presentation Table (Large Fonts)
- [`create_summary_table_publication()`](https://github.com/larry-leon/forestsearch/reference/create_summary_table_publication.md)
  : Preset: Publication-Ready Table
- [`create_sample_size_table()`](https://github.com/larry-leon/forestsearch/reference/create_sample_size_table.md)
...
- [`save_forestplot()`](https://github.com/larry-leon/forestsearch/reference/save_forestplot.md)
...
- [`print(`*`<fs_forest_theme>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_forest_theme.md)
  : Print Method for ForestSearch Forest Theme
- [`print(`*`<fs_forestplot>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_forestplot.md)
  : Print Method for ForestSearch Forest Plot
- [`plot(`*`<fs_forestplot>`*`)`](https://github.com/larry-leon/forestsearch/reference/plot.fs_forestplot.md)
  : Plot Method for ForestSearch Forest Plot
- [`create_subgroup_summary_df()`](https://github.com/larry-leon/forestsearch/reference/create_subgroup_summary_df.md)
...
- [`plot_km_band_forestsearch()`](https://github.com/larry-leon/forestsearch/reference/plot_km_band_forestsearch.md)
  ...
  Subgroups
- [`quick_km_band_plot()`](https://github.com/larry-leon/forestsearch/reference/quick_km_band_plot.md)
...
- [`print(`*`<fs_weighted_km>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_weighted_km.md)
...
- [`plot(`*`<fs_sg_plot>`*`)`](https://github.com/larry-leon/forestsearch/reference/plot.fs_sg_plot.md)
  : Plot Method for fs_sg_plot Objects
- [`print(`*`<fs_sg_plot>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.fs_sg_plot.md)
  : Print Method for fs_sg_plot Objects
- [`plot_subgroup_effects()`](https://github.com/larry-leon/forestsearch/reference/plot_subgroup_effects.md)
...
- [`plot_spline_treatment_effect()`](https://github.com/larry-leon/forestsearch/reference/plot_spline_treatment_effect.md)
  : Plot Spline Treatment Effect Function
- [`plot_detection_curve()`](https://github.com/larry-leon/forestsearch/reference/plot_detection_curve.md)
  : Plot Detection Probability Curve
- [`compare_detection_curves()`](https://github.com/larry-leon/forestsearch/reference/compare_detection_curves.md)
  : Compare Detection Curves Across Sample Sizes
- [`sens_text()`](https://github.com/larry-leon/forestsearch/reference/sens_text.md)
  : Generate Cross-Validation Sensitivity Text
- [`figure_note()`](https://github.com/larry-leon/forestsearch/reference/figure_note.md)
  : Generate Figure Note for Quarto/RMarkdown
- [`km_summary()`](https://github.com/larry-leon/forestsearch/reference/km_summary.md)
...
- [`get_dfpred()`](https://github.com/larry-leon/forestsearch/reference/get_dfpred.md)
  : Generate Prediction Dataset with Subgroup Treatment Recommendation
- [`dummy_encode()`](https://github.com/larry-leon/forestsearch/reference/dummy_encode.md)
  : Dummy-code a data frame (numeric pass-through, factors expanded)
- [`add_id_column()`](https://github.com/larry-leon/forestsearch/reference/add_id_column.md)
...
- [`evaluate_cuts_once()`](https://github.com/larry-leon/forestsearch/reference/evaluate_cuts_once.md)
  : Cache and validate cut expressions efficiently
- [`detect_variable_types()`](https://github.com/larry-leon/forestsearch/reference/detect_variable_types.md)
  : Automatically Detect Variable Types in a Dataset
- [`is_flag_continuous()`](https://github.com/larry-leon/forestsearch/reference/is_flag_continuous.md)
  : Check if cut expression is for a continuous variable (OPTIMIZED)
- [`is_flag_drop()`](https://github.com/larry-leon/forestsearch/reference/is_flag_drop.md)
  : Check if cut expression should be dropped
- [`is.continuous()`](https://github.com/larry-leon/forestsearch/reference/is.continuous.md)
  : Check if a variable is continuous
- [`get_cut_name()`](https://github.com/larry-leon/forestsearch/reference/get_cut_name.md)
  : Get variable name from cut expression
- [`cut_var()`](https://github.com/larry-leon/forestsearch/reference/cut_var.md)
  : Generate cut expressions for a variable
- [`lasso_selection()`](https://github.com/larry-leon/forestsearch/reference/lasso_selection.md)
  : LASSO selection for Cox model
- [`filter_by_lassokeep()`](https://github.com/larry-leon/forestsearch/reference/filter_by_lassokeep.md)
...
- [`extract_all_tree_cuts()`](https://github.com/larry-leon/forestsearch/reference/extract_all_tree_cuts.md)
  : Extract all cuts from fitted trees
- [`extract_selected_tree_cuts()`](https://github.com/larry-leon/forestsearch/reference/extract_selected_tree_cuts.md)
  : Extract cuts from selected tree only
- [`extract_tree_cuts()`](https://github.com/larry-leon/forestsearch/reference/extract_tree_cuts.md)
  : Extract cut information from a policy tree
- [`extract_idx_flagredundancy()`](https://github.com/larry-leon/forestsearch/reference/extract_idx_flagredundancy.md)
...
- [`print(`*`<gbsg_dgm>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.gbsg_dgm.md)
...
- [`get_dgm_with_output()`](https://github.com/larry-leon/forestsearch/reference/get_dgm_with_output.md)
...
- [`find_k_inter_for_target_hr()`](https://github.com/larry-leon/forestsearch/reference/find_k_inter_for_target_hr.md)
  : Find k_inter Value to Achieve Target Harm Subgroup Hazard Ratio
- [`validate_k_inter_effect()`](https://github.com/larry-leon/forestsearch/reference/validate_k_inter_effect.md)
...
- [`default_fs_params()`](https://github.com/larry-leon/forestsearch/reference/default_fs_params.md)
  : Default ForestSearch Parameters for GBSG Simulations
- [`default_grf_params()`](https://github.com/larry-leon/forestsearch/reference/default_grf_params.md)
  : Default GRF Parameters for GBSG Simulations
- [`summarize_simulation_results()`](https://github.com/larry-leon/forestsearch/reference/summarize_simulation_results.md)
  : Summarize Simulation Results
- [`format_oc_results()`](https://github.com/larry-leon/forestsearch/reference/format_oc_results.md)
  : Format Operating Characteristics Results as GT Table
- [`compute_detection_probability()`](https://github.com/larry-leon/forestsearch/reference/compute_detection_probability.md)
...
- [`find_required_sample_size()`](https://github.com/larry-leon/forestsearch/reference/find_required_sample_size.md)
  : Find Minimum Sample Size for Target Detection Power
- [`create_null_result()`](https://github.com/larry-leon/forestsearch/reference/create_null_result.md)
  : Create result object when no subgroup is found
- [`create_success_result()`](https://github.com/larry-leon/forestsearch/reference/create_success_result.md)
...
- [`validate_mrct_data()`](https://github.com/larry-leon/forestsearch/reference/validate_mrct_data.md)
...
- [`format_CI()`](https://github.com/larry-leon/forestsearch/reference/format_CI.md)
  : Format Confidence Interval for Estimates
- [`format_results()`](https://github.com/larry-leon/forestsearch/reference/format_results.md)
  : Format results for subgroup summary
- [`hrCI_format()`](https://github.com/larry-leon/forestsearch/reference/hrCI_format.md)
  : Format Hazard Ratio and Confidence Interval
- [`n_pcnt()`](https://github.com/larry-leon/forestsearch/reference/n_pcnt.md)
  : Calculate n and percent
- [`ci_est()`](https://github.com/larry-leon/forestsearch/reference/ci_est.md)
  : Confidence Interval for Estimate
- [`calc_cov()`](https://github.com/larry-leon/forestsearch/reference/calc_cov.md)
  : Calculate Covariance for Bootstrap Estimates
- [`get_targetEst()`](https://github.com/larry-leon/forestsearch/reference/get_targetEst.md)
  : Target Estimate and Standard Error for Bootstrap
- [`calculate_counts()`](https://github.com/larry-leon/forestsearch/reference/calculate_counts.md)
  : Calculate counts for subgroup summary
- [`calculate_potential_hr()`](https://github.com/larry-leon/forestsearch/reference/calculate_potential_hr.md)
  : Calculate potential outcome hazard ratio
- [`density_threshold_both()`](https://github.com/larry-leon/forestsearch/reference/density_threshold_both.md)
...
- [`qlow()`](https://github.com/larry-leon/forestsearch/reference/qlow.md)
  : 25th Percentile (Quantile Low)
- [`qhigh()`](https://github.com/larry-leon/forestsearch/reference/qhigh.md)
  : 75th Percentile (Quantile High)
- [`get_best_survreg()`](https://github.com/larry-leon/forestsearch/reference/get_best_survreg.md)
  : Get Best Model from Comparison
- [`compare_multiple_survreg()`](https://github.com/larry-leon/forestsearch/reference/compare_multiple_survreg.md)
  : Compare Multiple Survival Regression Models
- [`print(`*`<multi_survreg_comparison>`*`)`](https://github.com/larry-leon/forestsearch/reference/print.multi_survreg_comparison.md)
...
- [`filter_call_args()`](https://github.com/larry-leon/forestsearch/reference/filter_call_args.md)
  : Filter and merge arguments for function calls
- [`get_combinations_info()`](https://github.com/larry-leon/forestsearch/reference/get_combinations_info.md)
  : Get all combinations of subgroup factors up to maxk
- [`get_conf_force()`](https://github.com/larry-leon/forestsearch/reference/get_conf_force.md)
  : Get forced cut expressions for variables
- [`get_covs_in()`](https://github.com/larry-leon/forestsearch/reference/get_covs_in.md)
  : Get indicator vector for selected subgroup factors
- [`process_conf_force_expr()`](https://github.com/larry-leon/forestsearch/reference/process_conf_force_expr.md)
